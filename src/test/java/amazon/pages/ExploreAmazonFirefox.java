...
public class ExploreAmazonFirefox {
	
	public WebDriver driver;

	// Initialize Driver
	public ExploreAmazonFirefox(WebDriver driver) {
		this.driver = driver;
	}

	// locators
	/*
	 * By all_dropdown = By.xpath("//select[@title='Search in']"); By
	 * select_one_option = By.xpath("//option[text()='Amazon Devices']");
	 */
